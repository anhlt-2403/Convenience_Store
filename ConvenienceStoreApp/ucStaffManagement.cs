    ...
    public partial class ucStaffManagement : UserControl
    {
        ...
        public void LoadStaffList()
        {
            ...
            try
            {
                ...
                var admin = repoStaff.GetAllStaff().Where(staff => staff.RoleId == "AD");
                staffs.ForEach(staff => staffsCut.Add(new()
                {
                    ...
                    RoleId = staff.Role.RoleName,
                    StaffId = staff.StaffId,
                    StatusId = staff.Status.StatusName,
                }));
                ...
                else
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            {
                                if(staff.RoleId == "AD" && staff.StatusId == "PS001")
                                {
                                    repoStaff.Update(staff);
                                }
                                else
                                {
                                    MessageBox.Show("Admin cannot change status");
                                }
